...
U1 (LM7805, TO-220 package) takes an unregulated DC input voltage (VR_IN) and outputs a stable, regulated 5V (VR_OUT). C1 and C2 are input/output filter capacitors that stabilize the regulator and suppress noise/oscillation.

| J1 Pin | Signal  | Description                     |
|--------|---------|-----------------------------------|
| 1      | VR_IN   | Unregulated DC input (typically 7–25V for LM7805) |
| 2      | GND     | Common ground                     |

| J2 Pin | Signal   | Description             |
|--------|----------|---------------------------|
| 1      | VR_OUT   | Regulated 5V output       |
| 2      | GND      | Common ground              |
